  ...
  return (
    <section ref={ref} className="relative container w-full px-4 sm:px-6 lg:px-8">
      <div className="grid place-items-center lg:max-w-screen-xl gap-4 sm:gap-6 lg:gap-8 mx-auto pt-12 pb-4 sm:pt-16 md:pt-20 lg:pt-32 md:pb-8">
        ...
        >
          <Badge variant="outline" className="text-xs sm:text-sm py-2 px-3 mx-2">
            <span className="mr-2">
          ...
          <div className="max-w-screen-md mx-auto text-center px-2 sm:px-4">
          ...
          <p className="max-w-screen-sm mx-auto text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground px-4 sm:px-6 lg:px-0 leading-relaxed">
          ...
          >
            ...
            <Button
              asChild
              variant="secondary"
              className="w-full sm:w-72 md:w-auto md:px-6 lg:px-8 font-bold py-3 sm:py-4"
            >
              {/* <Link
        ...
        >
          ...
          <div className="w-full max-w-[1200px] mx-auto rounded-lg relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 overflow-hidden">
            {/* Dashboard Header */}
            <div className="bg-gray-800/80 px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 border-b border-gray-700/50">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  />
                  <span className="text-xs sm:text-sm text-gray-400 hidden md:inline">AI Agent OS - Dashboard</span>
                </div>
                <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <div className="p-2 sm:p-3 md:p-4 lg:p-6 space-y-3 sm:space-y-4 md:space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-2 md:gap-4">
                <div className="bg-gray-800/60 rounded-lg p-2 sm:p-3 md:p-4 border border-gray-700/30">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-lg flex items-center justify-center">
                      <div className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 bg-black rounded-sm"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-800/60 rounded-lg p-2 sm:p-3 md:p-4 border border-gray-700/30">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-xl md:text-2xl font-bold text-white">1,247</p>
                    </div>
                    <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-r from-green-400 to-emerald-500 rounded-lg flex items-center justify-center">
                ...
                <div className="bg-gray-800/60 rounded-lg p-2 sm:p-3 md:p-4 border border-gray-700/30">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-xl md:text-2xl font-bold text-white">94%</p>
                    </div>
                    <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-r from-blue-400 to-cyan-500 rounded-lg flex items-center justify-center">
                      <div className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 bg-white rounded-sm"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-800/60 rounded-lg p-2 sm:p-3 md:p-4 border border-gray-700/30">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg sm:text-xl md:text-2xl font-bold text-white">$45K</p>
                    </div>
                    <div className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-r from-purple-400 to-pink-500 rounded-lg flex items-center justify-center">
                      <div className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 bg-white rounded-sm"></div>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                {/* Agent List */}
                <div className="lg:col-span-2 bg-gray-800/60 rounded-lg p-3 sm:p-4 md:p-6 border border-gray-700/30">
                  <h3 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">Active AI Agents</h3>
                ...
                {/* Performance Chart */}
                <div className="bg-gray-800/60 rounded-lg p-3 sm:p-4 md:p-6 border border-gray-700/30">
                  <h3 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">Performance</h3>
              ...
              <div className="bg-gray-800/60 rounded-lg p-3 sm:p-4 md:p-6 border border-gray-700/30">
                <h3 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-4 sm:mb-6">Workflow Pipeline</h3>
                <div className="flex items-center justify-between w-full overflow-x-auto">
                  {[
                    ...
                    <div key={i} className="flex items-center flex-shrink-0">
                      ...
                      {i < 3 && (
                        <div className="w-6 sm:w-8 md:w-12 lg:w-16 h-px bg-gray-600 mx-2 sm:mx-3 md:mx-4 lg:mx-6"></div>
                      )}
                    </div>
                  ))}
                </div>
